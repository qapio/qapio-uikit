            ...
            <li className="flex items-center justify-center relative">
                ...
                >
                    {bottomVisible ? (
                        ...
                        <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="inherit"><path fillRule="evenodd" clipRule="evenodd" d="M2 1L1 2V14L2 15H14L15 14V2L14 1H2ZM2 10V2H14V10H2Z"/></svg>
                    ) : (
            ...
            <li className="flex items-center justify-center relative">
                ...
                >
                    {rightVisible ? (
                        ...
                        <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="inherit"><path fillRule="evenodd" clipRule="evenodd" d="M2 1L1 2V14L2 15H14L15 14V2L14 1H2ZM2 14V2H9V14H2Z"/></svg>
                    ) : (
